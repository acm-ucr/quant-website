...
const Project = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-3/4 max-lg:border-quant-gray max-lg:bg-quant-gray-100 min-h-fit rounded-lg text-sm max-lg:border-[1px] lg:flex lg:h-2/6 lg:w-fit lg:flex-col lg:text-lg"
    >
