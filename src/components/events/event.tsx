  ...
  return (
    <div className="flex items-center rounded-3xl bg-[#FFFFFF61] sm:h-1/3 sm:w-4/5 lg:h-1/3 lg:w-3/4">
      <div className="flex flex-col sm:h-full sm:w-4/5 sm:items-center sm:justify-start sm:pt-7 lg:h-full lg:w-1/5 lg:items-center lg:justify-center lg:pt-0">
        <div className="font-questrial text-quant-blue-100 sm:text-left sm:text-2xl lg:text-center lg:text-lg">
          {props.day}
        </div>
        <div className="font-questrial text-quant-white sm:text-left sm:text-6xl sm:font-bold lg:text-center lg:text-7xl">
          {props.date}
        </div>
      </div>
      <div className="flex flex-col sm:h-full lg:h-full lg:w-4/5">
        <div className="justify-start pt-10 font-questrial font-medium text-quant-white sm:text-3xl lg:pl-10 lg:text-4xl">
          {props.title}
        </div>
        ...
        <div className="sm:w-5/7 font-roboto text-lg text-quant-gray sm:h-full sm:pt-3 sm:text-base lg:h-full lg:w-5/6 lg:pl-10 lg:pt-2">
          {props.description}
        </div>
      </div>
    </div>
