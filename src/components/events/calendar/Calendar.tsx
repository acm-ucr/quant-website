...
import page from "@/public/events/quantcalendarBG.webp";
...
const Calendar = ({ events }: { events: EventProps[] }) => {
  ...
  return (
    <div className="relative mb-[15vw] mt-[4vw] flex flex-col items-center justify-center">
      ...
      <div className="absolute top-[-5.5%] z-30 flex flex-row space-x-3 font-hanken text-xl md:top-[-3.5%] md:space-x-10 md:text-6xl">
      ...
      <CalendarEvents
        ...
        onSelect={setDate}
        events={events}
        className="relative z-20 h-[70vw] w-[70vw] rounded-xl bg-purple-300 p-3 font-questrial"
      />
    </div>
  );
};
